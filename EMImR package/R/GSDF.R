#' Gene Specific data filter
#'
#' @param expression expression datframe
#' @param methylation methykation dataframe
#' @param miRNA miRNA dataframe
#' @param target_gene gene symbol
#'
#' @return GSD
#' @export
